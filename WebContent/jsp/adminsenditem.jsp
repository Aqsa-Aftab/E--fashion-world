...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-center" style="padding: 16px">
    <h1 class="w3-jumbo w3-text-blue">SENTITEMS</b></h1>
	...
	<%
			hs = request.getSession();
				...
				String str = "select * from sentitem where senderid=? order by dateofmsg desc";

				ResultSet rs = CrudOperation.getData(str, userid);
				int f=0;
		%> 
  ...
  <div class="w3-padding-32 w3-content">
   <br> <br> <br>
			<form action="/e-fashion/SendItem" method="post">
				<table class="table">
					<tr>
						<th>Select</th>
						<th>Receiver</th>
					...
					%>
					<tr>
						<td><input type="checkbox" name="chk" value="<%=msgid%>"></td>
						<td><%=rs.getString("receiverid")%></td>
						<td><b><a
							href="/e-fashion/jsp/viewadminsentmessage.jsp?id=<%=msgid%>"
							style="text-decoration: none"><%=rs.getString("subject")%> </a></b></td>
						<td><%=rs.getString("dateofmsg")%></td>
					</tr>
					<%
						}
					%>
