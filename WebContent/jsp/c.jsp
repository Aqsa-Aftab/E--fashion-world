		...
		<div class="container">			
			<div class="col-md-8 single-page-left">
				<div class="single-page-info">
					<h3>Industrial Design Centre (IDC)</h3>
					<img src="/e-fashion/images/ids.jpg" alt=""/>
					<p>Several areas have been identified for research. Faculty members along with students and 
					other research and design staff work together on these issues.
                        
                    
                     <p>The centre interacts with industries and institutions for promotion and awareness of design. These are in the form of organizing seminars, conducting short term courses and workshops. In the area of design practice, IDC offers professional design consultancy and advisory services to industries and other organizations.
					</p>  
