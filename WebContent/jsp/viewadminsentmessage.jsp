...
<div class="w3-padding-large">
			...
			int msgid = Integer.parseInt(request.getParameter("id"));
				String sql = "select * from sentitem where msgid=?";
		...
		<!-- Contact Section -->
		<<div class="w3-padding-64 w3-content  w3-text-dark-grey" id="contact">
			<h2><label>Sent To:</label></h2><h2 style="color: #00fa9a; font-size: 3s0px; font-family: verdana"><%=rs.getString("receiverid")%></h2>
			<br> <br> <br>
			...
			<p>
				<textarea class="w3-input w3-white w3-padding-64" type="text"
					name="message" readonly><%=rs.getString("message")%></textarea>
			</p>
			<p>
				<%
					}
				...
				%>
				<br> <br> <a href="/e-fashion/jsp/adminsenditem.jsp"
