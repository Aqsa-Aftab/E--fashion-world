		...
		<div class="container">			
			<div class="col-md-8 single-page-left">
				<div class="single-page-info">
					<h3>Srishti Institute of Art, Design & Technology</h3>
					<img src="/e-fashion/images/d1.jpg" alt=""/>
					<p>The Srishti community of learners consists of a diverse set of artists, designers,
					 practitioners and educators from around the world, many of whom are acknowledged leaders 
					 in their respective fields.

                   <p>  Srishti's culture encourages thinking, questioning and experimenting to harness the artistic and intellectual potential of each individual and place the institution at the leading edge of contemporary art and design discourse.A multi-disciplinary approach inculcates self-initiated learning and independent thinking and expands perceptual perspectives. Regular interaction with design studios, production and distribution centers, community projects, retail establishments and industry forms a vital bridge between Srishti and the world.</p>  
