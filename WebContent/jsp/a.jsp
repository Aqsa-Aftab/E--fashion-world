...
<body>
	...
	<div class="top-nav">
		...
		<ul class="nav1 cl-effect-11">
			...
			<li><a href="/e-fashion/jsp/contact.jsp" data-hover="Contact Us">Contact Us</a></li>		</ul>				
		<!-- script-for-menu -->
		 <script>
		...
		<div class="container">			
			<div class="col-md-8 single-page-left">
				<div class="single-page-info">
					<h3>MIT Institute of Design</h3>
					<img src="/e-fashion/images/mit.jpg" alt=""/>
					<p>The institute was established by MAEER's (Maharashtra Academy of Engineering & Education Research)
					 Group in 2006. It focuses on design education with a core concept of progress in historical time and 
					 geographical space. It offers Graduate Diploma Programme (GDP), Postgraduate Diploma Programme (PGDP)
					  and Fashion Courses. Some of the design disciplines on offer are:

                    <p>Industrial Design: Product Design, Transportation Design, Interior Space & Equipment Design, Retail & Exhibition Design, User Experience Design (only at PG level)
                    </p>
                     <p>   Communication Design: Graphic Design, Animation Film Design, Film & Video Design
The institute also offers collaborative programmes with some international universities such as University of Gloucestershire, Middlesex University, etc..</p>  
					 
					<div class="comment-icons">
						<ul>
							
							<li><span class="clndr"></span>MARCH 30, 2018</li>
				...
				<div class="row related-posts">
					...
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="#" class="thumbnail">
							<img src="/e-fashion/images/img11.jpg" alt=""/>
						</a>
						<h5><a href="#">Lorem Ipsum is simply</a></h5>
					</div>	
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="#" class="thumbnail">
							<img src="/e-fashion/images/img14.jpg" alt=""/>
						</a>
						<h5><a href="#">Lorem Ipsum is simply</a></h5>
					</div>
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="#" class="thumbnail">
							<img src="/e-fashion/images/img15.jpg" alt=""/>
						</a>
						<h5><a href="#">Lorem Ipsum is simply</a></h5>
					</div>
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="#" class="thumbnail">
							<img src="/e-fashion/images/img16.jpg" alt=""/>
						</a>
						<h5><a href="#">Lorem Ipsum is simply</a></h5>
					</div>					
				</div>				
				...
				<div class="response">
					...
					<div class="media response-info">
						<div class="media-left response-text-left">
							<a href="#">
								<img class="media-object" src="/e-fashion/images/icon2.png" alt=""/>
							</a>
	...
	<div class="footer">
		<div class="container">
			<p>Copyright © 2018 Fashion world. All rights reserved </p>
		</div>
	</div>
	<!--//footer-->
	<script type="text/javascript">
