...
<div class="buttons-wrapper" style="float: left; background-color:  " >	

			<form action="/e-fashion/Company" method="post">
						...
						<div class="col-md-6 contact-wthree-right">
									...
									<input type="text"  name="ceoname" placeholder="CEO Name" required="">
									<input type="text"  name="city" placeholder="City" required="">
									<input type="text"  name="registrationno" placeholder="Registration No" required="">
									
									<textarea name="about" placeholder="About Company" required=""></textarea>
						...
						<div class="col-md-6 contact-wthree-right"> 
									...
									<textarea name="work" placeholder="Comapny Works" required=""></textarea>
				...
				<div class="col-md-6 contact-wthree-right">  <input type="submit" value="SAVE Company Details" > </div>
				  </form>	</div>
