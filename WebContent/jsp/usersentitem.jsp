            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case">Sent Items</h4>
                    </header>
                    </section>
		...
		%>
					...
					%>
                        <tr class="unread">
                            ...
                            <td class="view-message  dont-show"><%=rs1.getString("receiverid")%></td>
                            <td class="view-message "><b><a
							href="/e-fashion/jsp/userviewsentitem.jsp?id=<%=msgid%>"
